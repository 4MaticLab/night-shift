...
// Custom lamp icon component
const BrassLanternIcon: ComponentType<{ size?: number; strokeWidth?: number }> = ({ size = 80 }) => (
  <Image
    src="https://iili.io/COCnQxs.md.png"
    alt="黄铜提灯"
    width={size}
    height={size}
...
// Custom flower icon component
const FlowerNoteIcon: ComponentType<{ size?: number; strokeWidth?: number }> = ({ size = 80 }) => (
  <Image
    src="https://iili.io/COCgz8u.md.png"
    alt="夜香花笺"
    width={size}
    height={size}
    style={{ objectFit: "contain" }}
...
// Custom coins icon component
const TramFareIcon: ComponentType<{ size?: number; strokeWidth?: number }> = ({ size = 80 }) => (
  <Image
    src="https://iili.io/COCrdKP.md.png"
    alt="旧制电车零钱"
    width={size}
    height={size}
    style={{ objectFit: "contain" }}
