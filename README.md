...
案件书架目前收录《零点四十三分的末班车》《只在雨中播出的电台》与《黎明前出炉的第十三个面包》三套完整五夜剧本，各自拥有独立线索、推理、结局和本地存档；同一夜班运行时可以继续接入新的 `CampaignManifest`。真实夜班会按设备本地交接时间冻结掌灯、夜半、末更或白昼小憩，改变城市侧影而不评价作息；短暂醒转还可以留下每夜最多一次、不会结束调查的睡隙回声。
