...
export function CaseBoard() {
  ...
  const selectedClues = selectedClueIds.map((id) => nightShiftCase.clues.find((clue) => clue.id === id)).filter((clue): clue is Clue => clue !== undefined);
