...
- [[docs/rdk-x5-sleep-sentry]] — Mini Lindo（小林渡）RDK X5 床头哨站：名分、板端代理、桌宠桥接协议、降级回退与隐私边界。
- [[docs/mini-lindo-sensor-guide]] — Mini Lindo 传感器手册：40PIN 接线、逐路驱动细节、字段流向、mock 参照与板上排障。
