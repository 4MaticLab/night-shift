...
>(({ children, className, disabled, ...props }, ref) => {
  return (
    ...
    >
      <span
        className="relative inline-flex items-center gap-2 size-full text-sm tracking-wide text-[rgb(0,0,0,65%)] uppercase dark:font-light dark:text-[rgb(255,255,255,90%)]"
        style={{
          maskImage:
