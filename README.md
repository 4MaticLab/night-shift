...
一款“旅行青蛙式期待感 × 睡眠行为 × 异步侦探叙事 × 收藏与推理”的本地优先网页游戏。首个案件《零点四十三分的末班车》包含五夜固定剧情、12 条带城市异议和页边批注的核心线索、8 件收藏品、会记住摆放的交互案件板，以及会把真实旅程重新编成结案卷宗的三个结局。真实夜班会按设备本地交接时间冻结掌灯、夜半、末更或白昼小憩，改变城市侧影而不评价作息；短暂醒转还可以留下每夜最多一次、不会结束调查的睡隙回声。
