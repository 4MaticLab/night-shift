  ...
  return (
    <main className="hero-shell">
      ...
      <section className="hero-copy">
        <p className="eyebrow hero-kicker"><span className="hero-kicker-copy"><Moon size={14} /> {t("一款与你轮班生活的异步侦探游戏")}</span><span className="shift-rule"><span className="shift-rule-face shift-rule-day"><b aria-hidden="true">●</b>{t("你负责白天推理")}</span><span className="shift-rule-face shift-rule-night"><b aria-hidden="true">☾</b>{t("林渡负责夜晚调查")}</span></span></p>
        <h1>{locale === "en" ? <><span className="hero-title-print">When you fall asleep,</span><em className="hero-title-hand">his work begins.</em></> : <><span className="hero-title-print">你睡着以后，</span><em className="hero-title-hand">他才开始工作。</em></>}</h1>
        <p className="hero-lede hero-lede-note">{t("白天分析线索，晚上把调查交给侦探。等你醒来，雾灯城会留下一份新的报告。")}</p>
